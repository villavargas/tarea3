 ...
 */
package de.hybris.platform.acceleratorocc.payment.service.impl;
...
public class DefaultPaymentSubscriptionResultServiceTest
{
	...
	{
		given(paymentSubscriptionResultDao.findPaymentSubscriptionResultByCart(UNKNOWN_CART_CODE))
	...
	{
		given(paymentSubscriptionResultDao.findPaymentSubscriptionResultByCart(CART_CODE))
				.willReturn(paymentSubscriptionResultModel);
