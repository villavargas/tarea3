 ...
 */
package de.hybris.platform.acceleratorocc.payment.facade.impl;
...
public class DefaultCommerceWebServicesPaymentFacadeTest
{
	...
	{
		given(paymentSubscriptionResultService.findPaymentSubscriptionResultByCart(CART_CODE))
				.willThrow(new UnknownIdentifierException("not found"));
