...
/**
 * The type Allow shipment telmex action.
 */
public class AllowShipmentTelmexAction extends AbstractAction<ConsignmentProcessModel> {
    private static final Logger LOG = Logger.getLogger(AllowShipmentTelmexAction.class);
