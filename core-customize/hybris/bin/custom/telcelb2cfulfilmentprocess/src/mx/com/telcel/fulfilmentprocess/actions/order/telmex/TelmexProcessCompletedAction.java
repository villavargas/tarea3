...
/**
 * The type Telmex process completed action.
 */
public class TelmexProcessCompletedAction extends AbstractSimpleDecisionAction<OrderProcessModel> {
    private static final Logger LOG = Logger.getLogger(TelmexProcessCompletedAction.class);
