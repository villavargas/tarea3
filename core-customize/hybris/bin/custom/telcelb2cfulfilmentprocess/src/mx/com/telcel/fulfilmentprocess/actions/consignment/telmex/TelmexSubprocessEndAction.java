...
public class TelmexSubprocessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
    private static final Logger LOG = Logger.getLogger(TelmexSubprocessEndAction.class);
    ...
    public void executeAction(final ConsignmentProcessModel process)
    {
        ...
        getBusinessProcessService().triggerEvent(
                process.getParentProcess().getCode() + "_"
                        + Telcelb2cFulfilmentProcessConstants.TELMEX_CONSIGNMENT_SUBPROCESS_END_EVENT_NAME);
