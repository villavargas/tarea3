...
/**
 * The type Waiting to telmex be shipped action.
 */
public class WaitingToTelmexBeShippedAction extends AbstractAction<ConsignmentProcessModel> {
    private static final Logger LOG = Logger.getLogger(WaitingToTelmexBeShippedAction.class);
