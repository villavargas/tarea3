 ...
 */
package mx.com.telcel.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Telcelb2cFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Telcelb2cFulfilmentProcessConstants.PARENT_PROCESS);
