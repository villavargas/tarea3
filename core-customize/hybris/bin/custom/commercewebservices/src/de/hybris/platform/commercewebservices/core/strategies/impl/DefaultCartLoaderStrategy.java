 ...
 */
package de.hybris.platform.commercewebservices.core.strategies.impl;
...
import mx.com.telcel.core.services.impl.B2cTelcelCommerceCartMergingStrategy;
...
{
    private static final Logger LOG = Logger.getLogger(DefaultCartLoaderStrategy.class);
    ...
    public void loadCart(final String cartId, final boolean refresh)
    {
        ...
        {
            LOG.error("Could not load cart to session: " +ex.getMessage());
        }
    }
    ...
    protected void loadUserCart(final String cartID, final boolean refresh)
    {
        ...
        else
        {
            ...
            {
               // throw new CartException(CART_NOT_FOUND_MESSAGE, CartException.NOT_FOUND, requestedCartID);
                LOG.error(CART_NOT_FOUND_MESSAGE+" "+requestedCartID);
                return;
            }
            restoreCart(cart, requestedCartID, refresh);
        }
