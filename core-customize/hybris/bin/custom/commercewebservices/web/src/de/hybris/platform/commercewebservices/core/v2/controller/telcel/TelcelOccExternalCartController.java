...
//@RequestMapping(value = "/{baseSiteId}/externalOCC/addCartEntry")
@CacheControl(directive = CacheControlDirective.NO_STORE)
public class TelcelOccExternalCartController {
    private static final Logger LOG = Logger.getLogger(TelcelOccExternalCartController.class);
