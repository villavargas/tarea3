...
import de.hybris.platform.commercewebservices.core.swagger.ApiBaseSiteIdAndUserIdAndPaymentDetailsParams;
...
public class PaymentDetailsController extends BaseCommerceController
{
	...
	public static final String FIELDS = "payments(DEFAULT,zipCode,tokenCard,holderName,paymentType,promotions)";
