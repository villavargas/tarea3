...
import mx.com.telcel.swagger.ApiBaseSiteIdAndUserIdAndAddressParams;
...
public class AddressController extends BaseCommerceController
{
	...
	@ResponseBody
	@ApiBaseSiteIdAndUserIdParam
	@ApiOperation(nickname = "validateAddressBilling", value = "Validate Address billing.", notes = "Validate Address billing.",
			consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public AddressWsDTO validateAddressBilling(@ApiParam(value = "Guid ID", required = true) @PathVariable String guid,
