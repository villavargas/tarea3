 ...
 */
package mx.com.telcel.test.setup;
...
import mx.com.telcel.test.constants.Telcelb2cTestConstants;
import mx.com.telcel.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Telcelb2cTestConstants.EXTENSIONNAME)
...
//			importImpexFile(context, "/telcelb2ctest/import/qa-test-users.impex");
//
//			LOG.info("Creating Reviews...");
//			importImpexFile(context, "/telcelb2ctest/import/reviews.impex");
//
//			LOG.info("Creating Test Payment Subscriptions...");
//			getAcceleratorTestOrderData().createPaymentInfos();
//
//			LOG.info("Creating CS Tickets...");
//			importImpexFile(context, "/telcelb2ctest/import/cstickets.impex");
//
...
//			importImpexFile(context, "/telcelb2ctest/import/csquotes.impex");
		}
	}
}
