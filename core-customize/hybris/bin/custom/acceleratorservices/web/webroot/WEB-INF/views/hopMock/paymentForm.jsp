...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="${fn:escapeXml(currentLanguageIso)}" lang="${fn:escapeXml(currentLanguageIso)}">
<head>
	...
	<div id="wrapper">
		<div id="page">
			...
			<div id="item_container_holder">
				<div class="item_container">
					<div id="welcome">
						<h3>
							...
							<c:out value=" ${fn:escapeXml(paymentDetailsForm.billingAddress.firstName)} ${fn:escapeXml(paymentDetailsForm.billingAddress.lastName)}"/>
						</h3>
						<h4>
				...
				<div class="item_container">
					<form:form id="paymentDetailsForm" name="paymentDetailsForm" action="${fn:escapeXml(hopResponseActionUrl)}" method="post" modelAttribute="paymentDetailsForm">
						...
						<div>
							<img alt="Visa" src="${fn:escapeXml(imgCardVisaPath)}"/>
							<img alt="MasterCard" src="${fn:escapeXml(imgCardMastercardPath)}"/>
							<img alt="Maestro (UK Domestic)" src="${fn:escapeXml(imgCardMaestroPath)}"/>
							<img alt="American Express" src="${fn:escapeXml(imgCardAmericanExpressPath)}"/>
							<img alt="Diners Club" src="${fn:escapeXml(imgCardDinersClubPath)}"/>
						</div>
						<div class="form">
							<dl>
			...
			<div style="clear: both;"></div>
			<div id="footer">
				<%--- Footer INFO GOES HERE: <img alt="logo" src="${fn:escapeXml(imgLogoPath)}"/> --%>
			</div>
		</div>
	</div>
</body>
