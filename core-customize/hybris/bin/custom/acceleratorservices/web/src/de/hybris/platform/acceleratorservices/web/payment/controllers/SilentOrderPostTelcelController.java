...
@Controller
@RequestMapping("/sop")
public class SilentOrderPostTelcelController
{
    ...
    @RequestMapping(value = "/process-telcel", method = RequestMethod.POST)
                                    ...
                                    final HttpServletRequest request, final Model model)
    {
        ...
        else
        {
            ...
            if(form.getCard_accountNumber() != null){
                String cardAccountNumber = form.getCard_accountNumber().trim().replace("-","");
                final String endPortion = cardAccountNumber.trim().substring(cardAccountNumber.length() - 4);
