...
public class DefaultImpexConverterTest
{
	...
	{
		converter.setEnableEscaping(true);
		converter.setImpexRow(";{0}");

		final String escapedImpex = converter.convert(rows("test;1"), null);

		assertThat(escapedImpex).isEqualTo(";\"test;1\"");
	}
	...
	@Test
	public void shouldDoubleEscapePartsOfEscapedValue() //reproduce ECP-1119
	{
		converter.setImpexRow(";{0}");
	...
	@Test
	public void shouldDoubleEscapeEnclosingDoublequotesValues() //mitigate ECP-1119
	{
		converter.setEnableEscaping(true);
		converter.setImpexRow(";{0}");
	...
	public void shouldEscapeCRInValue()
	{
		...
		final String escapedImpex = converter.convert(rows("test\r1"), null);

		assertThat(escapedImpex).isEqualTo(";\"test\r1\"");
	}
	...
	public void shouldEscapeLFInValue()
	{
		...
		final String escapedImpex = converter.convert(rows("test\n1"), null);

		assertThat(escapedImpex).isEqualTo(";\"test\n1\"");
	}
