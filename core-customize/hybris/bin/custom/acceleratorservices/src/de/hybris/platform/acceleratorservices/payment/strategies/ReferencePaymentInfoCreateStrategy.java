...
public interface ReferencePaymentInfoCreateStrategy {

    ReferencePaymentInfoModel createReferencePaymentInfo(final SubscriptionInfoData subscriptionInfo,
    ...
    ReferencePaymentInfoModel saveSubscription(CustomerModel customerModel, CustomerInfoData customerInfoData,
