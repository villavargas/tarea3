...
import mx.com.telcel.core.model.CancellationUserOthersProcessModel;
import mx.com.telcel.core.util.TelcelUtil;
import mx.com.telcel.facades.product.TelcelProductFacade;


/**
 * The type Cancellation user others email contex.
 */
public class CancellationUserOthersEmailContext extends AbstractEmailContext<CancellationUserOthersProcessModel>
{
	...
	@Override
	public void init(final CancellationUserOthersProcessModel cancellationUserOthersProcessModel,
			final EmailPageModel emailPageModel)
	{
		super.init(cancellationUserOthersProcessModel, emailPageModel);
		final ConsignmentModel consignmentModel = cancellationUserOthersProcessModel.getConsignment();
		final ReturnRequestModel returnRequestModel = cancellationUserOthersProcessModel.getReturnRequest();
	...
	@Override
	protected BaseSiteModel getSite(final CancellationUserOthersProcessModel businessProcessModel)
	{
		return businessProcessModel.getSite();
	}

	@Override
	protected CustomerModel getCustomer(final CancellationUserOthersProcessModel businessProcessModel)
	{
		return businessProcessModel.getCustomer();
	}

	@Override
	protected LanguageModel getEmailLanguage(final CancellationUserOthersProcessModel businessProcessModel)
	{
