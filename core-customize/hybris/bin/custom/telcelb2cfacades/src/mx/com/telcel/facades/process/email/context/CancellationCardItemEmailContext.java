...
import mx.com.telcel.core.model.CancellationCardItemProcessModel;
...
/**
 * The type Cancellation card item email contex.
 */
public class CancellationCardItemEmailContext extends AbstractEmailContext<CancellationCardItemProcessModel>
{
	...
	@Override
	public void init(final CancellationCardItemProcessModel cancellationCardItemProcessModel, final EmailPageModel emailPageModel)
	{
		super.init(cancellationCardItemProcessModel, emailPageModel);
		final ConsignmentModel consignmentModel = cancellationCardItemProcessModel.getConsignment();
		final ReturnRequestModel returnRequestModel = cancellationCardItemProcessModel.getReturnRequest();
	...
	@Override
	protected BaseSiteModel getSite(final CancellationCardItemProcessModel businessProcessModel)
	{
		return businessProcessModel.getSite();
	}

	@Override
	protected CustomerModel getCustomer(final CancellationCardItemProcessModel businessProcessModel)
	{
		return businessProcessModel.getCustomer();
	}

	@Override
	protected LanguageModel getEmailLanguage(final CancellationCardItemProcessModel businessProcessModel)
	{
