...
import static mx.com.telcel.constants.Telcelb2cwebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static mx.com.telcel.constants.Telcelb2cwebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
import mx.com.telcel.data.UserDataList;
import mx.com.telcel.dto.SampleWsDTO;
import mx.com.telcel.dto.TestMapWsDTO;
import mx.com.telcel.dto.UserWsDTO;
import mx.com.telcel.dto.UsersListWsDTO;
import mx.com.telcel.dto.UsersPageWsDTO;
import mx.com.telcel.facades.SampleFacades;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/telcelb2cwebservices/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/telcelb2cwebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/usersPaged
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/telcelb2cwebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/telcelb2cwebservices/sample/map
	 *
	 */
