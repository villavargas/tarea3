...
/**
 * Global class for all Telcelb2cwebservices constants. You can add global constants for your extension into this class.
 */
@SuppressWarnings({"deprecation","squid:CallToDeprecatedMethod"})
public final class Telcelb2cwebservicesConstants extends GeneratedTelcelb2cwebservicesConstants
{
	public static final String EXTENSIONNAME = "telcelb2cwebservices";
	...
	public static final String HOST = "telcelb2cwebservices.host";
	public static final String HOST_DEFAULT = "hostname";

	private Telcelb2cwebservicesConstants()
	{
